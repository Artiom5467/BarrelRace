...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        ...
        {
            NeverBrake, // автомобіль прискорюється на повну швидкість постійно.
            TargetDirectionDifference,  
            TargetDistance, 
        }

      
        [SerializeField][Range(0, 1)] private float m_CautiousSpeedFactor = 0.05f;// відсоток максимальної швидкості( використовувати при максимально обережному руху)
        [SerializeField][Range(0, 180)] private float m_CautiousMaxAngle = 50f; // кут підходу до повороту
        [SerializeField] private float m_CautiousMaxDistance = 100f;// відстань, на якій починається обережність
        [SerializeField] private float m_CautiousAngularVelocityFactor = 30f;// яким обережним повиннен бути штучний інтелект
        [SerializeField] private float m_SteerSensitivity = 0.05f;// як чутливо ШІ  повертає
        [SerializeField] private float m_AccelSensitivity = 0.04f;// як чутливо ШІ  прискорюється
        [SerializeField] private float m_BrakeSensitivity = 1f; //як чутливо ШІ гаоьмує
